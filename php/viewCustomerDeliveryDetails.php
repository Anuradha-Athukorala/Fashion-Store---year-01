...
<table border="1px" width="100%" id="tbl1" style="border:1px solid black">
	<tr>
		...
		<th class="col7">Postal Code</th>
		<th class="col7">Country</th>
	</tr>
...
<?php
	...
	if($result->num_rows>0){
		while($row = $result->fetch_assoc()){
			echo "<tr><td>".$row["id"]."</td><td>".$row["first_name"]."</td><td>".$row["last_name"]."</td><td>".$row["mobile"]."</td><td>".$row["email"]."</td><td>".$row["address"]."</td><td>".$row["city"]."</td><td>".$row["postalcode"]."</td><td>".$row["country"]."</td></tr>";
		}
